...
GitHub allows for amazing collaboration to happen! For this morning’s exercise, we will work together to get you set up for collaboration during Project 3.

## Deliverables

Using collaboration via GitHub, each pair will create a new repo **outside the class repo** and collaborate to finish the assignment.
