...
<!--SEI1 8:04 -->
<!--SEI1 8:29 before split-->

## A Lesson on Git Branches and Merging

<!--Project 3 is going to be a group project, and in order to submit work, you can't just rely on git push origin master...you will have to share code and not overwrite other people's changes.  Welcome to Unit 3.  Welcome to git branching. -->

<!--Do this as team fundamentals and team independence -->
...
<!-- If they don't see this, then they can run `git config --local help.autocorrect`-->
...
<details><summary> Screeshot </summary>
...
<details><summary> Here is an example of screen management (You will have to also account for Zoom and Slack): </summary>
...
<details><summary>Screenshot</summary>![image from below of github](https://i.imgur.com/YtFNJEk.png)
</details>
...
<details><summary>Screenshot</summary>![github screenshot](https://i.imgur.com/mgEzi40.png)
</details>
