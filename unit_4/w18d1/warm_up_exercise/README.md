...
<!--Why are we learning Sass now? Well, because Rails natively supports it, and a lot of styling in Rails is done with .scss files. Students will definitely want to use it for Project 4-->
...
<!--Go ahead and copy-and-paste this-->
