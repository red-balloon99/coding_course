...
**Check the results of your commands in the Elements tab and in the Console** (some `div`s won't have text, etc. but you can see the element appearing in the DOM in the elements tab.)

Remember: to see it in the **console**, you will need to either log the JS code or save the code to a variable and log the variable. Save your file and the refresh your browser after any changes.
...
Use `document.querySelector()` to find one element.
...
>**Big Hint:** Look at the bottom of the previous lesson for a method that would get an element by ID.  This section will come in handy for other problems in this lab as well.
...
&#x1F535;  Change the style/color of the text of ONE of your `li` elements to your [favorite html color](https://htmlcolorcodes.com/color-names/)
...
Change the style/color of the text of ALL of your `li` elements to another [favorite html color](https://htmlcolorcodes.com/color-names/)  

#### Remove an element:

&#x1F535; Select any element using `querySelector` and save it to a variable

&#x1F535; Remove that element from your page using `.remove()`
