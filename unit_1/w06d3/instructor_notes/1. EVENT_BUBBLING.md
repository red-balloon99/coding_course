...
<!--starter code is in student_examples-->
...
<!--Explain this is a lot like our class lesson--each DOM element is a backup plan for its children, until we run out of parents-->
...
<!--Pause and ask folks to slack answers, then test-->
<!--SEI1 9:25 -->
