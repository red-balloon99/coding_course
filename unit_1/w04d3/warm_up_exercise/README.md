...
Take 10 minutes to sketch out the mockup below. You do not need to go into detail: boxes are just fine but you should include:

- The tags you will use (e.g. `img`, `p`)
- The percentage size of each box
- Classes that you will apply to similar elements

## Setup

1. `git pull upstream master` to get this morning's starter code.
