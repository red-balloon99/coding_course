...
<!-- Perforce was the main part of my job for 2 years -->
...
<!--All of my day-job repos are in GitLab -->
...
<!--Highly recommend setting this up over the weekend before starting homework-->
<!--SEI1 12:42 -->

## Practice Making a Github Repo

<!--Have students work through this on their own, and share screen if stuck -->
...
<!--Have all students send their link when they get to this step and help students who are stuck-->
...
<!--SEI1 1:14 -->
<!--When done, have students thumbs-up, so an IA can check results and help stragglers -->
...
<!--Have all students share their links in slack -->
...
<!--Have students send link to their forked version -->
...
<!--Make sure no one has "sei-flex" in there anywhere-->
...
<!--Have students paste the value of their `upstream` in the above command -->
<!--SEI1 2:15 -->
...
<!--When done have students thumbs up so an IA can check that `example.js` is live-->
...
<!--Thumbs up when they can see the change on their GitHub fork -->
