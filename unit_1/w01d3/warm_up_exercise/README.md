...
<!--Good idea here is to ask for a Mac volunteer to share their screen--we can guarantee that they will get everything installed correctly-->
...
Monitors
![Monitors Labeled.png](../student_examples/fluid_floats/monitors_labeled.png)
...
<!--Stress the importance of this, keep practicing to ~30 min per week, but if you feel like your typing skills could use work, do it EVERY WEEK -->
