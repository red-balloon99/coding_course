...
The term “mystery meat” is a reference to school cafeteria meals that are so processed that their exact type is no longer discernible.

Mystery Meat Navigation refers to cases where the destination of a link is not visible until the user clicks on it or points the cursor at it.
...
### Google's Home Screen Is:

 - Goal Focused
 - Invisible
 - Forgiving
 - Consistent
 - Smooth for Onboarding
...
Share your user stories in Slack after we wrap up!  
