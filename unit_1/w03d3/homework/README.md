...
Yikes. Well, copy the bondFilms **array** of **objects** above into your JS file. Use **for loops**, conditionals, and methods in order to complete the below:
...
Where `key` is a variable that instantiates the keys in object, and `obj` is the name
