...
1. Check if Jarvis is there by calling the `jarvisAreYouThere` function
...
In early 2017, digital archaeologists discovered the strangest, nonsensical combined data structure. Like in Raiders of the Lost Ark, they refused to look at it directly for fear of melting their faces off.
...
1. Attempt some kata on [CodeWars](https://www.codewars.com/) or [HackerRank](https://www.hackerrank.com/)!
