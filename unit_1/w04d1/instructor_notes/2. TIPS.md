...
<!--Create a basic `index.html` that includes a `script` tag then add the code below-->
...
<!--Add the example below so they can see how it works:
...
<!--Why after 2/3/4 rando is undefined-->
...
- Type `cont` to go to the next `debugger` line
- Type `repl` to examine variables

<!--use the socky examples from the earlier lesson on this, and put a couple debuggers in the callbacks/main function -->

## Use Proper Indentation

Always indent your code.  If a chunk of code is being executed under a certain condition (if/else, loops, functions), that condition owns that chunk of code.  Show ownership with indentation:
...
This is the case if you have nested loops or if/else, too:
...
- Better to have to type a long variable name than get confused later on.
...
It is a great idea for you to have your functions grouped together at the top.  This way you know all your functions will be defined before they're called.
...
When doing this, sometimes you'll need to change a variable's datatype
