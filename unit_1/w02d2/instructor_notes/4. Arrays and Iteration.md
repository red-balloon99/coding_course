...
<!--For this class, we need to lift the no-copy-paste rule for arrays *only*-->
<!--A lot of these examples, you can just show, too-->
...
<!--SEI1 6:26 -->
<!--We very much won't be ahead of schedule -->
