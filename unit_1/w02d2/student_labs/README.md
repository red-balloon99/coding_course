...
<!--SEI1 started at 6:35, finished at 7:45 -->

# Today's Lab

## Directions

Use or create the file `lab_solutions.js` in this `student_labs` folder to write arrays, loops, `if`, or `if, else` statements to complete the following questions. Refer back to your class notes from today if you need help.

>**Note:** You may have to research some of these steps online.
...
### Mix It Up
1. Save the following array `const myArray = [5, 10, 500, 20]`
...
### Biggie Smalls
Write an `if...else` statement inside a `for` loop that iterates over all numbers in the `myArray` array declared above:
...
Write a loop that prints the numbers below in order
