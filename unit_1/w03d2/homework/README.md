...
1. At any point, **only if you are currently using rusty scissors**, you can buy an old-timey push lawnmower for $25.  You can do this once, assuming you have enough money.
...
1. At any point, **only if you currently have the old-timey push lawnmower**, you can buy a fancy battery-powered lawnmower for $250.  You can do this once, assuming you have enough money.
...
1. At any point, **only if you currently have the fancy battery-powered lawnmower**, you can buy a lawn mowing robot for $500.  You can do this once, assuming you have enough money.

    <hr>
    &#x1F534;  <b>Commit your work!</b> <br>
    Your commit message should read something like: <br>
    "landscaper: user can buy a robot"
    <hr>

1. Using the the robot, you can spend the day cutting lawns and make $250.  You can do this as much as you want.

    <hr>
    &#x1F534;  <b>Commit your work!</b> <br>
    Your commit message should read something like: <br>
    "landscaper: user can use a robot to cut grass"
    <hr>

1. You win the game when you have a robot and $1000.  In this situation, send a message to the user telling them they've won.
