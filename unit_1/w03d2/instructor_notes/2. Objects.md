...
<!--Squad up for this, then share with group, have them list to themselves while breakout rooms set -->
...
The class can suggest properties to add to the person object.
...
<!--Students don't need to type here -->
...
<!--Only instructor typing till activity below -->
...
<!--This is the main time you will need to use square braces, i.e. if the property is variable, because you can't use a dot for this -->
...
This is another time where you need to access key-values using square brackets and quotes `obj['1']`
