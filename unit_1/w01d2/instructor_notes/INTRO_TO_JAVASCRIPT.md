...
<!--Student exercise: console log the value of 20 + 20 -->
...
<!--Some have made it a point to forget semicolons in their life.
	Rather than get embroiled in a discussion about semicolons, just know...
	...when in doubt, use one.  For the remainder of this course, you may be in doubt
	...so use one.
	That being said, a certain instructional lead does not use them at all in his day job.
	So he will do his best with them, but go easy on him.
-->
...
<!--Think for a minute or test, then share solutions in Slack -->
<!--SEI1 8:44 -->
...
* Use the `+` operator to **concatenate** these four strings together within a console.log: "Please", "squeeze", "the", "cheese". Make sure there are spaces in-between each word.
...
<!--show of thumbs: up for true, down for false to check answers -->
<!--SEI1 9:14  -->
