...
<!--Worth stressing again that we used findOneAndUpdate and findOneAndRemove today, but likely we'd use the findById options for Project 2-->
<!--SEI1 7:22 -->

### Intermediate

We can count how many tweets we have with likes greater than or equal to 20
