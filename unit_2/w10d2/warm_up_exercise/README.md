...
You've been given starter code for a pretty awful looking website (`warm_up_exercise/starter_code/`).  Fix it up and make it C.R.A.P.!  
...
#### CRAP
- [More Detailed Post](https://vwo.com/blog/crap-design-principles/)
